...
class CompletedDetailsApiService{


  static const String url = "${baseURL}api/complete-details";

  static Future CompletedDetailsApiCall(BuildContext context,String userId,String jobid) async {
    try {
