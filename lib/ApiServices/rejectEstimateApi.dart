...
class RejectEstimateApi{


  static const String url = "${baseURL}api/rejectestimate";

  static Future RejectEstimateApiCall(BuildContext context,String userId,String jobid) async {
    try {
