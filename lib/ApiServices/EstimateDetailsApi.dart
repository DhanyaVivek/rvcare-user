...
class EstimateDetailsApiService{


  static const String url = "${baseURL}api/estimate-details";

  static Future<ModelEstimatedetails?> EstimateDetailsApiCall(BuildContext context,String userId,String jobid) async {
    try {
